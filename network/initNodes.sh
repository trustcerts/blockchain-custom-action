...
curl -X POST "http://localhost:4551/init" -H "accept: */*" -H "Authorization: Bearer test" -H "Content-Type: application/json" -d "{\"id\":\"did:trust:tc:test:id:BfjXrhHYXJd7Rg9HaD3ocX\",\"secret\":\"foobar\",\"url\":\"testing-validator1_http_1:3000\"}"
echo "add observer" &
