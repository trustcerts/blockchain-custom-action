...
curl -X POST "http://localhost:4501/did/genesis" -H "accept: */*" -H "Authorization: Bearer test" -H "Content-Type: application/json" -d "[\"validator1_network_1:3000\",\"validator2_network_1:3000\",\"validator3_network_1:3000\",\"validator4_network_1:3000\"]"
...
echo "add gateway" &
curl -X POST "http://localhost:4541/init" -H "accept: */*" -H "Authorization: Bearer test" -H "Content-Type: application/json" -d "{\"id\":\"did:trust:tc:dev:id:4GqRUNp2wRgnHAPUZb8X9X\",\"secret\":\"foobar\",\"url\":\"validator1_http_1:3000\"}"
curl -X POST "http://localhost:4551/init" -H "accept: */*" -H "Authorization: Bearer test" -H "Content-Type: application/json" -d "{\"id\":\"did:trust:tc:dev:id:BfjXrhHYXJd7Rg9HaD3ocX\",\"secret\":\"foobar\",\"url\":\"validator1_http_1:3000\"}"
echo "add observer" &
curl -X POST "http://localhost:4561/init" -H "ac cept: */*" -H "Authorization: Bearer test" -H "Content-Type: application/json" -d "{\"id\":\"did:trust:tc:dev:id:FDPrCrhPCnVPgSyWEfQyJj\",\"secret\":\"foobar\",\"url\":\"validator1_http_1:3000\"}"
curl -X POST "http://localhost:4571/init" -H "accept: */*" -H "Authorization: Bearer test" -H "Content-Type: application/json" -d "{\"id\":\"did:trust:tc:dev:id:6xNu7M86KFu4B4hYNNg2GD\",\"secret\":\"foobar\",\"url\":\"validator1_http_1:3000\"}"
echo "add client"
